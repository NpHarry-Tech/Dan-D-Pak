...
- **iPad** (`ipad.html`): khách tự gọi món, xem menu quyển, gửi bếp, gọi nhân viên, yêu cầu thanh toán, chọn xuất/không xuất hóa đơn VAT sau khi trả tiền. Nhân viên mở khóa bằng PIN thiết bị.
