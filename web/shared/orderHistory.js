...
import { api, money, esc, toast } from './client.js';
...
async function showDetail(id) {
  ...
  let r;
  try { r = await api(`/orders/${id}/receipt`); } catch (e) { detailEl.innerHTML = `<div class="oh-empty">Lỗi: ${esc(e.message)}</div>`; return; }
...
// ---- Receipt model helpers (BCM "Hóa đơn bán hàng khởi tạo từ máy tính tiền") ----
