...
class _InvoicesScreenState extends State<InvoicesScreen> {
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    return _invoices.where((i) {
      ...
      final c = i['customer'] is Map ? (i['customer'] as Map) : const {};
      return [
        i['invoice_no'],
        i['lookup_code'],
        c['name'],
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    child: KpiCard(
                        label: 'Tổng tiền HĐ', value: Fmt.money(totalIssued))),
                const SizedBox(width: 12),
                Expanded(
                    child: KpiCard(
                        label: 'Đã hủy',
  ...
  Widget _body() {
    ...
    if (_error != null && _invoices.isEmpty) {
      return Padding(
        ...
        child: InlineMessage('Không tải được hóa đơn ($_error)',
  ...
  Widget _row(Map<String, dynamic> inv) {
    ...
    final c = inv['customer'] is Map ? (inv['customer'] as Map) : const {};
              ...
              children: [
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(cancelled ? 'Đã hủy' : 'Đã phát hành',
                          style: TextStyle(
                              fontSize: 11,
                              fontWeight: FontWeight.w800,
                              color: cancelled
                ...
                Text(
                  [
                    ...
                    if (_s(c['tax_code']).isNotEmpty) 'MST ${_s(c['tax_code'])}',
