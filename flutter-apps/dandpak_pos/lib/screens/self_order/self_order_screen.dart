...
/// nhân viên, chờ xác nhận) vào một WebView toàn màn hình — KHÔNG viết lại UI
/// mới, mọi cải tiến trên /ipad tự có mặt ở đây. Nội dung đơn khách đặt đi
/// thẳng lên server trung tâm nên realtime đồng bộ với POS/KDS mọi thiết bị.
///
/// Kiosk: khách không có nút thoát. Nhân viên thoát bằng cách chạm 5 lần liên
/// tiếp vào góc trên-trái trong vòng 3 giây.
