...
class WindowControls {
  static const _ch = MethodChannel('dandpak/window');
...
class _WinBtnState extends State<_WinBtn> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.tooltip == 'Đóng') {
      dotColor = const Color(0xFFFF5F56); // macOS Close Red
      displayIcon = Icons.close;
    } else if (widget.tooltip == 'Thu nhỏ') {
      dotColor = const Color(0xFFFFBD2E); // macOS Minimize Yellow
      displayIcon = Icons.remove;
    } else {
      dotColor = const Color(0xFF27C93F); // macOS Maximize Green
...
class WindowChrome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const t = 6.0; // resize band thickness
    return Stack(
      children: [
        Positioned.fill(child: child),
        // Edges
        _edge(left: 0, top: t, bottom: t, width: t, cursor: SystemMouseCursors.resizeLeftRight, dir: 'left'),
        _edge(right: 0, top: t, bottom: t, width: t, cursor: SystemMouseCursors.resizeLeftRight, dir: 'right'),
        _edge(top: 0, left: t, right: t, height: t, cursor: SystemMouseCursors.resizeUpDown, dir: 'top'),
        _edge(bottom: 0, left: t, right: t, height: t, cursor: SystemMouseCursors.resizeUpDown, dir: 'bottom'),
        // Corners
        _edge(left: 0, top: 0, width: t, height: t, cursor: SystemMouseCursors.resizeUpLeftDownRight, dir: 'topLeft'),
        _edge(right: 0, top: 0, width: t, height: t, cursor: SystemMouseCursors.resizeUpRightDownLeft, dir: 'topRight'),
        _edge(left: 0, bottom: 0, width: t, height: t, cursor: SystemMouseCursors.resizeUpRightDownLeft, dir: 'bottomLeft'),
        _edge(right: 0, bottom: 0, width: t, height: t, cursor: SystemMouseCursors.resizeUpLeftDownRight, dir: 'bottomRight'),
