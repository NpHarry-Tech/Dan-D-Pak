...
import 'package:dandpak_pos/screens/management/print_template_designer.dart';
      ...
      home: Scaffold(
        body: SizedBox(
          ...
          child: PrintTemplateDesigner(
            api: ApiService(),
            initialConfig: const {
              'bill': {'storeName': 'Dan D Pak', 'address': 'Đường D9', 'widthMm': 80, 'heightMm': 320},
              ...
              'templates': {
                'bill': {
                  ...
                  'elements': [
                    {'type': 'image', 'y': 1, 'x': 38, 'label': 'Logo', 'src': ''},
                    {'type': 'text', 'y': 2, 'x': 5, 'text': 'HÓA ĐƠN THANH TOÁN', 'align': 'center', 'bold': true},
                    {'type': 'line', 'y': 3},
                    {'type': 'text', 'y': 4, 'x': 5, 'text': '{items}'},
                    {'type': 'qr', 'y': 5, 'x': 30, 'qrText': '{invoiceLookupUrl}'},
                  ],
                },
              },
            },
