...
class _StocktakeLine {
  ...
  num? get countedNum => kvParseNum(counted.text);
  ...
  void _applyImport(String raw) {
    ...
    for (final it in _items) {
      ...
      if (barcode.isNotEmpty)
        byCode.putIfAbsent(barcode.toLowerCase(), () => it);
    }
                        ...
                        KvMetaTotalRow(
                            ...
                            accent: _totalDelta == 0
                                ...
                                : _totalDelta > 0
                                    ...
                                    : DanColors.late),
                        SizedBox(height: 2),
                        Text(t('Hoàn thành = lưu phiếu và cân bằng kho ngay. Lưu tạm để kiểm tiếp sau.'),
                            style: TextStyle(
