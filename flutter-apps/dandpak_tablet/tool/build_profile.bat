@echo off
REM Build dandpak_tablet Windows PROFILE (do hieu nang bang Flutter DevTools).
REM Chay app profile: build xong mo build\windows\x64\runner\Profile\dandpak_tablet.exe
