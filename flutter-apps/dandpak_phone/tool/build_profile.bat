@echo off
REM Build dandpak_phone Windows PROFILE (do hieu nang bang Flutter DevTools).
REM Chay app profile: build xong mo build\windows\x64\runner\Profile\dandpak_phone.exe
