...
export const MODULES = [
  ...
  { key: 'tablet', label: 'Tablet App (Flutter)', icon: '📱', group: 'sales', href: '/tablet', perm: 'module.tablet', status: 'active', depends: ['pos', 'kds', 'warehouse'], description: 'Ứng dụng Tablet Native (bản web) gồm Gọi món, KDS và Quản lý Kho.' },
