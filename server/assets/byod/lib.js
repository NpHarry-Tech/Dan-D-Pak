...
export const STR = {
  vi: {
    ...
    all: 'Tất cả', soldOut: 'Hết món', prepTime: '~{min} phút', addToCart: 'Thêm vào giỏ hàng', total: 'Tổng tiền',
    ...
    callStaffConfirmTitle: 'Gọi nhân viên hỗ trợ?', callStaffConfirmBody: 'Nhân viên sẽ nhận được thông báo và tới bàn bạn ngay.', cancel: 'Hủy',
  ...
  en: {
    ...
    all: 'All', soldOut: 'Sold out', prepTime: '~{min} min', addToCart: 'Add to cart', total: 'Total',
    ...
    callStaffConfirmTitle: 'Call staff for support?', callStaffConfirmBody: 'Staff will be notified and come to your table right away.', cancel: 'Cancel',
  ...
  zh: {
    ...
    all: '全部', soldOut: '已售完', prepTime: '约{min}分钟', addToCart: '加入购物车', total: '总计',
    ...
    callStaffConfirmTitle: '呼叫服务员支援？', callStaffConfirmBody: '服务员会收到通知并立即到您的桌台。', cancel: '取消',
  ...
  ja: {
    ...
    all: 'すべて', soldOut: '売り切れ', prepTime: '約{min}分', addToCart: 'カートに追加', total: '合計',
    ...
    callStaffConfirmTitle: 'スタッフのサポートを呼びますか？', callStaffConfirmBody: 'スタッフに通知が届き、すぐにテーブルへ伺います。', cancel: 'キャンセル',
  ...
  ko: {
    ...
    all: '전체', soldOut: '품절', prepTime: '약 {min}분', addToCart: '장바구니에 담기', total: '합계',
    ...
    callStaffConfirmTitle: '직원 호출을 요청하시겠습니까?', callStaffConfirmBody: '직원에게 알림이 전송되며 곧 테이블로 찾아갑니다.', cancel: '취소',
